...
<tr>
	...
	<td><?php echo $row['P_fechaI']; ?></td>
				...
				<td style="width:3%;"><a href="#" data-href="EliminarProgramado.php?Id_programado=<?php echo $row['Id_programado']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="icon-bin" style="color: #FFFFFF;"></span></a></td>
</tr>
	<?php } ?>
</tbody>
	</table>
