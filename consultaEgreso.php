...
if (!empty($valor)) {
	$where = "WHERE Eg_nombre LIKE '%$valor%'";
}
...
<tr>
	...
	<td><?php echo $row['Eg_nombre']; ?></td>
	<td><?php echo $row['Eg_apellidos']; ?></td>
	<td><?php echo $row['Eg_estado']; ?></td>
	<td><?php echo $row['Eg_dias']; ?></td>
	<td><?php echo $row['Eg_cirugias']; ?></td>
