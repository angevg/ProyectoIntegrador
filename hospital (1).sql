...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2020 a las 04:59:26
...
(21, 'Anabel', 'Vargas garcia', 'f', '14', 'Dominicana', '', 1546852134, '2005-11-11', 'Av Max', '0', 2147483647, 'Norka', 2147483647, '12:00:00.0000', '2020-05-11'),
...
(23, '', '', '', '', '', '', 0, '0000-00-00', '', '0', 0, '', 0, '00:00:00.0000', '0000-00-00');
...
ALTER TABLE `tdefuncion`
  ...
  ADD KEY `Id_intrahospitalaria` (`Id_intrahospitalaria`);
...
--
ALTER TABLE `tdefuncion`
  MODIFY `Id_defuncion` int(100) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tingresoprogramado`
  MODIFY `Id_programado` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `ttraslado`
--
ALTER TABLE `ttraslado`
  MODIFY `Id_traslado` int(100) NOT NULL AUTO_INCREMENT;
